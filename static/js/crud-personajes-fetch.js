...
const BASEURL = 'https://mpujia.pythonanywhere.com/';
...
async function savePersonaje(){
  ...
  let result = null;
  // Si hay un idPersonaje, realiza una petición PUT para actualizar al personaje
  if(idPersonaje!==""){
    result = await fetchData(`${BASEURL}/api/personajes/${idPersonaje}`, 'PUT', personajeData);
  }else{
    // Si no hay idPersonaje, realiza una petición POST para crear un nuevo personaje
...
async function showPersonajes(){
  ...
  personajes.forEach((personaje,index) => {
    let tr = `<tr>
                  ...
                  <td>
                      <img src="${'../static/img/Personajes/' + personaje.url_foto}" width="80" width="10%">
                  </td>
                  <td>                      
                      <button class="btn-personaje" onclick='updatePersonaje(${personaje.id_personaje})' type="button" id="btn-update-personaje">Modificar</button>
                      <button class="btn-personaje" onclick='deletePersonaje(${personaje.id_personaje})' type="button" id="btn-delete-personaje">Eliminar</button>
                  </td>
                </tr>`;
...
/**
 * Function que permite eliminar un personaje del array del localstorage
